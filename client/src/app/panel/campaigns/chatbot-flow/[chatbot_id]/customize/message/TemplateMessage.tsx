...
import { countOccurrences, parseToSeconds } from '@/lib/utils';
import { Carousel } from '@/schema/template';
import { useRef, useState } from 'react';
import toast from 'react-hot-toast';

export type TextMessageProps = {
	onTemplateMessageAdded: (
...
const TemplateMessage = ({ onTemplateMessageAdded, children }: TextMessageProps) => {
...
TemplateMessage.displayName = 'TemplateMessage';
