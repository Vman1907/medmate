		...
		<div className='flex flex-col gap-4 justify-center p-4 w-full h-full'>
			...
			>
				...
				<Panel position='bottom-right'>
					<div className='flex flex-col gap-2 backdrop-blur-md rounded-md shadow-md pb-6 p-2'>
						<Label className='text-destructive'>
							<Info className='inline-block w-4 h-4 mr-2 ' />
							Please add a start node to begin sending message and lead nurturing.
						</Label>
						<Label className='text-destructive'>
							<Info className='inline-block w-4 h-4 mr-2 ' />
							Lead nurturing is not designed to work if an end node exists.
						</Label>
						<Label className='text-destructive'>
							<Info className='inline-block w-4 h-4 mr-2 ' />
							Nodes are uneditable once added—delete to modify.
						</Label>
						<Label className='text-destructive'>
							<Info className='inline-block w-4 h-4 mr-2 ' />
