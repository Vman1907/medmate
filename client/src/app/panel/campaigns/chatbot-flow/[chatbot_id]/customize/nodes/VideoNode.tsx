	...
	return (
		<>
			...
			<div className='rounded-2xl bg-gray-200 min-w-[400px] min-h-max-content shadow-2xl drop-shadow-2xl'>
				<div className='bg-purple-400 text-center text-white rounded-t-2xl h-12 flex justify-center items-center font-medium text-lg'>
					Video Message
				</div>
				{delay > 0 ? (
				...
				<div className='p-2'>
					<div className='rounded-lg border border-black p-2 max-h-min max-w-[400px]'>
						<PreviewFile
							data={{
								type: 'video',
