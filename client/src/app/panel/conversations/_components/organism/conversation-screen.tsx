...
import { ConversationNoteDialog } from '../atoms/dialogs';
import { MessagesListFallback } from '../atoms/fallback';
import MessageBox from '../molecules/message-input';
import MessageTagsView from '../molecules/message-tag-view';
import MessagesList from '../molecules/messages-list';

export default function ConversationScreen() {
	const { active_recipient: recipient } = useConversationStore();
	const {
	...
	return (
		<div className={`${!isExpanded ? '!w-full' : '!hidden md:!flex flex-1 flex-col'}`}>
			<div className='flex p-1 md:p-4 border-b-2 justify-between w-full'>
				...
				<div className='flex'>
					<div className=' flex items-center gap-3'>
						<Show.ShowIf condition={!loading || !!expiry}>
