...
import AssignLabelDialog from '../atoms/dialogs';
...
export function RecipientContextMenu({
	...
	const isPinned = recipient.conversation_ui_tag.includes('pinned');
	const isArchived = recipient.conversation_ui_tag.includes('archived');
